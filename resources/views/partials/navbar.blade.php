<div class="bg-zinc-200 text-zinc-900 text-sm py-2 px-6 flex justify-between items-center border-b border-zinc-300 shadow-sm">
    ...
    <div class="flex items-center space-x-4"><a href="https://www.facebook.com/p/Eat-The-Ball-61572240317030/" target="_blank" class="hover:text-yellow-500 flex items-center gap-1">
    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        ...
        <div class="mt-4 flex flex-wrap gap-6 text-lg items-center">
            ...
            <div class="ml-auto flex gap-2">
                <a href="{{ route('tickets') }}" class="ajax-link bg-yellow-500 border border-zinc-500 text-black px-4 py-2 rounded font-semibold inline-flex items-center gap-2">
