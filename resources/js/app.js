...
const searchIndex = [
    ...
    { label: 'Terminarz ŁZKosz', url: '/schedule/lzkosz', keywords: ['łzkosz', 'elzkosz', 'terminarz łzkosz'] },
    { label: 'III liga mężczyzn ŁZKosz', url: '/schedule/third-league', keywords: ['iii liga', '3 liga', 'ezkosz', 'e-zkosz'] },
];
