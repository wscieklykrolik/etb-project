...
use App\Http\Controllers\MessageOrderController;
...
Route::get('/informacje/{slug}', [ImportantPageController::class, 'show'])->name('important-pages.show');
Route::view('/polityka-cookies', 'pages.cookie-policy')->name('cookies.policy');
...
Route::get('/zamowienie/wiadomosc', MessageOrderController::class)->name('message-order.show');
Route::post('/zamowienie/wiadomosc', MessageOrderController::class)->middleware('throttle:20,1')->name('message-order.generate');
...
Route::middleware(['auth', EnsureLegacyShop::class])->group(function () {
...
Route::get('/checkout/confirmation/{order}', [CheckoutController::class, 'confirmation'])->middleware('auth')->name('checkout.confirmation');
Route::post('/payment/przelewy24/webhook', [CheckoutController::class, 'webhook'])->middleware(EnsureLegacyShop::class)->name('payment.przelewy24.webhook');
